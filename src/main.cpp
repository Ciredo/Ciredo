...
unsigned int nTargetSpacing = 3 * 30;
...
const string strMessageMagic = "Ciredo Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Ciredo: check proof-of-stake block signature
...
// Ciredo: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ciredo", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        bnTrustedModulus.SetHex("");
    ...
    {
        bnTrustedModulus.SetHex("");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1545754511;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 9089738;
        if(fTestNet)
        {
            block.nNonce   = 9089738;
        }
       ...
       if (nDoGenesis && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0x512b59c5766329fd23991ad169ddcfd6f35710a52d674cdd15c42a6bbaa2c9e3"));
...
unsigned char pchMessageStart[4] = { 0xb1, 0xc5, 0xf5, 0xb2 };
